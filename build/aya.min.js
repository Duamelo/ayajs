var t,s;t=this,s=function(exports){"use strict";var h={svg:{fill:"white"},form:{stroke:"black",fill:"white",strokeOpacity:"1",strokeWidth:"1px",fillOpacity:"1",limitWidth:20,limitHeight:20},arc:{stroke:"black",fill:"white",strokeOpacity:"1",strokeWidth:"1px",fillOpacity:"1",limitWidth:20,limitHeight:20},box:{stroke:"black",strokeWidth:"1px",fill:"none",strokeDasharray:"4"},point:{fill:"black",strokeWidth:"1pt",radius:3},line:{fill:"black",ends:{start:{type:"circle"},dest:{type:"triangle"}}},text:{fill:"black",fillOpacity:"100",stroke:"black",strokeWidth:"0.5pt",strokeOpacity:100,strokeDasharray:10.5,strokeDashoffset:10.5}},i={};class u{static add(t){i[t.uuid]=t}static find(t){return i[t]}static clear(t){delete i[t]}static findAllLink(s){var e=[];return Object.keys(i).map(t=>{t=u.find(t);"link"!=t.type||s.uuid!=t.source.ref&&s.uuid!=t.destination.ref||e.push(t)}),e}static findAllComponents(){var s=[];return Object.keys(i).map(t=>{t=u.find(t);t instanceof e&&s.push(t)}),s}}class y{static generate(){return Math.random().toString(36).substring(2,15)+Math.random().toString(36).substring(2,15)}}class l{constructor(t,s=0,e=0,i=5,h,n,r){this.ref=t,this.uuid=y.generate(),this.x=s,this.y=e,this.r=i,this.scale=1,this.events={},this.nativeEvent=n,this.config=r,this.type="point",this.c_svg="",this.svg=h,u.add(this)}addEvent(t,s){this.c_svg.addEventListener(t,s),this.events[t]=s}deleteEvent(t){var s=this.events[t];this.c_svg.removeEventListener(t,s),delete this.events[t]}setScale(t){this.scale=t}getScale(){return this.scale}draw(){this.c_svg=document.createElementNS("http://www.w3.org/2000/svg","circle"),this.c_svg.setAttribute("id",this.uuid),this.c_svg.setAttribute("cx",this.x),this.c_svg.setAttribute("cy",this.y),this.c_svg.setAttribute("r",this.config.point.radius*this.scale),this.c_svg.setAttribute("class","hidden_point"),this.addEvent("mousedown",this.nativeEvent.mouseDownCb),this.addEvent("mouseover",t=>{this.r+=4,this.c_svg.setAttribute("r",this.r)}),this.addEvent("mouseleave",t=>{this.r=this.config.point.radius,this.c_svg.setAttribute("r",this.r)}),this.svg.appendChild(this.c_svg)}removeFromDOM(){this.svg.removeChild(this.c_svg)}shift(t,s){this.x+=t,this.y+=s}redraw(){this.c_svg.setAttribute("cx",this.x),this.c_svg.setAttribute("cy",this.y),this.c_svg.setAttribute("r",this.config.point.radius*this.scale)}}class t{addEvent(t,s){}deleteEvent(t){}addChild(t,s,e){}setOffsetX(t){}setOffsetY(t){}setScaleX(t){}setScaleY(t){}getOffsetX(){}getOffsetY(){}getScaleX(){}getScaleY(){}setRotateCenter(t,s){}setRotateAngle(t){}drawVertex(){}drawConnector(){}drawBox(){}draw(t){}removeFromDOM(){}redraw(){}shift(t,s){}resize(t,s,e){}optimalPath(t){}}class r extends t{constructor(t,s=0,e=0,i=5,h,n,r){super(),this.uuid=t,this.x=s,this.y=e,this.r=i,this.events={},this.nativeEvent=n,this.config=r,this.box="",this.c_svg="",this.svg=h,this.type="circle",this.scale=1,this.offsetX=0,this.offsetY=0,this.angle=0,this.children=[],this.c_points=[new l(this.uuid,0,0,3,this.svg,this.nativeEvent,this.config),new l(this.uuid,0,0,3,this.svg,this.nativeEvent,this.config),new l(this.uuid,0,0,3,this.svg,this.nativeEvent,this.config),new l(this.uuid,0,0,3,this.svg,this.nativeEvent,this.config)],this.vertex=[new l(this.uuid,0,0,3,this.svg,this.nativeEvent,this.config),new l(this.uuid,0,0,3,this.svg,this.nativeEvent,this.config),new l(this.uuid,0,0,3,this.svg,this.nativeEvent,this.config),new l(this.uuid,0,0,3,this.svg,this.nativeEvent,this.config)]}addEvent(t,s){this.c_svg.addEventListener(t,s),this.events[t]=s}deleteEvent(t){var s=this.events[t];this.c_svg.removeEventListener(t,s),delete this.events[t]}addChild(t,s=null,e=null,i=!1){null!=s&&s(this,t),null!=e&&e(this,t),1==i&&t.draw(),this.children.push({child:t,translate:s,rotate:e})}drawVertex(){0!=this.vertex.length&&(this.vertex[0].x=this.x+this.offsetX-this.r*this.scale,this.vertex[0].y=this.y+this.offsetY-this.r*this.scale,this.vertex[1].x=this.x+this.offsetX+this.r*this.scale,this.vertex[1].y=this.y+this.offsetY-this.r*this.scale,this.vertex[2].x=this.x+this.offsetX+this.r*this.scale,this.vertex[2].y=this.y+this.offsetY+this.r*this.scale,this.vertex[3].x=this.x+this.offsetX-this.r*this.scale,this.vertex[3].y=this.y+this.offsetY+this.r*this.scale)}drawConnector(){0!=this.c_points.length&&(this.c_points[0].x=this.x+this.offsetX,this.c_points[0].y=this.y+this.offsetY-this.r*this.scale,this.c_points[1].x=this.x+this.offsetX+this.r*this.scale,this.c_points[1].y=this.y+this.offsetY,this.c_points[2].x=this.x+this.offsetX,this.c_points[2].y=this.y+this.offsetY+this.r*this.scale,this.c_points[3].x=this.x+this.offsetX-this.r*this.scale,this.c_points[3].y=this.y+this.offsetY)}drawBox(){var t;0<this.vertex.length&&0<this.c_points.length&&(t=`M ${this.vertex[0].x} ${this.vertex[0].y}
