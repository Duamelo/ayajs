(function (global, factory) {
	  ...
	  constructor( uuid,  x1 = 0,  y1 = 0,  x2 = 5, y2 = 5, x3 = 10, y3 = 10,  events = [] )
	   {
	    ...
	    this.vertex = [
	      new Point$1(this.uuid, this.x1, this.y1, 5),
	      new Point$1(this.uuid, this.x2, this.y2, 5),
	      new Point$1(this.uuid, this.x3, this.y3, 5),
	    ];
	    this.drawConnector();
	  }
	...
	class Losange {
	    ...
	    constructor(uuid, x1 = 200, y1 = 300, x2 = 100, y2 = 400, x3 = 200, y3 = 500, x4 = 300, y4 = 400, events = [] )
	    {
	        ...
	        this.vertex = [
	            ...
	            new Point$1(this.uuid, this.x2, this.y2, 5),
	            new Point$1(this.uuid, this.x3, this.y3, 5),
	            new Point$1(this.uuid, this.x4, this.y4, 5),
	        ];
	        this.drawConnector();
	    }
	...
	class FactoryForm
	{
	   ...
	   static createForm(uuid, type, props = {}, events)
	    {
	        if(type == "circle")
	            return new Circle$1(uuid, props.x, props.y, props.r, events);
